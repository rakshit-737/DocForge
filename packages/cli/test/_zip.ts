/* Minimal zip reader for .docx inspection — copied verbatim from
   packages/export-docx/test/_zip.ts (the same technique as
   qa/golden/_zip.mjs; tests must not import across packages or qa/).
