/* ============================================================
   docx-fonts.js — embed real bold/italic cuts into the .docx
...
const DocxFonts = (() => {
  ...
  function rebuild(bytes, entries, replacements) {
    ...
    for (const e of entries) {
      ...
      let method, crc, compSize, rawSize, data;
  ...
  function regroup(xml, families) {
    ...
    const body = families.map(fam => {
      ...
      if (!embeds) return "";
      const sig = (parts[fam.cuts.regular] || {}).sig || "";
