/* Minimal zip reader for golden-master .docx inspection. Handles stored (0) and
   deflated (8) members — everything the docx lib and Office emit. No dependency. */
import zlib from "node:zlib";

/** @returns {Map<string, Buffer>} member name → bytes */
